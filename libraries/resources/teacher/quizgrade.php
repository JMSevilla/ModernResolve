    ...
    <div class="card mt-4" style="width: 100%;" >
        <div class="card-body">
            ...
            <el-form :label-position="studassignLabelPosition" label-width="100px" :model="quiz" >
                ...
                <div v-for="(domain, index) in quizgradeFetchData">
                    ...
                    <div v-if="domain.quiz_type == 'Short Answer' && domain.question != null && domain.points != null">
                        <el-form-item>
                            ...
                            <el-col :span="22">
                                ...
                                <label style="margin-top: 20px; margin-right: 10px; color: #606266" >Grade this Answer</label>
                                    
                                    <el-input
                                        type="number"
                                        id="grading" 
                                        style="width: 5%"
                                        v-model="domain.score_points">
                                    </el-input>
                                    <span style="font-size: 1.5em; margin-left: 10px; margin-right: 10px" >
                                        / </span> 
                                    <el-input
                                        type="number"
                                        id="grading" 
