<el-menu class="el-menu-demo" mode="horizontal" id="adminnavbar">
  ...
  <el-menu-item style="float: right; margin-right: 3%">
    ...
    <el-dropdown-menu slot="dropdown">
      <el-dropdown-item @click.native="resetteacherdialogVisible = true" icon="el-icon-key">  Reset Password </el-dropdown-item>
...
<?php include("libraries/resources/teacher/resetModal.php"); ?>